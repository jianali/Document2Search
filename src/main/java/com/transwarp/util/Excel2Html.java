...
public class Excel2Html {
     ...
     */
    public static String readExcelToHtml(InputStream is,String htmlPositon, boolean isWithStyle){
    ...
    private static void writeFile(String content,String htmlPath){
        ...
        try {
            ...
            sb.append("<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\"><title>文件预览</title></head><body>");
            sb.append("<div>");
            sb.append(content);
            sb.append("</div>");
            sb.append("</body></html>");

            PrintStream printStream = new PrintStream(new FileOutputStream(file2),true,"GBK");
